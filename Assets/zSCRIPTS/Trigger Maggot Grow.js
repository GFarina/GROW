...
function OnTriggerEnter (other:Collider){
 ...
 if(other.collider.gameObject.tag == "AIR") allIn[0]=true;
	else  if(other.collider.gameObject.tag == "SEED") allIn[1]=true;
...
function OnTriggerExit (other:Collider){
 ...
 if(other.collider.gameObject.tag == "AIR") allIn[0]=false;
	else  if(other.collider.gameObject.tag == "SEED") allIn[1]=false;
