        ...
        touch.phase != iPhoneTouchPhase.Canceled    
         ...
         if (!hit.rigidbody || hit.rigidbody.isKinematic) {
            return;
               ...
               (GameObject.Find("Main Camera").GetComponent("TOUCH_TO_MOVE_CONSTRAINED_X_AXIS_FRICTION_Good 1")as Behaviour ).enabled = false;
               Debug.Log(" Disable ");
...
function DragObject(distance : float) {
  ...
  Destroy(dragger);
   ...
   (GameObject.Find("Main Camera").GetComponent("TOUCH_TO_MOVE_CONSTRAINED_X_AXIS_FRICTION_Good 1")as Behaviour ).enabled = true;
               Debug.Log(" Enabled ");
} 
