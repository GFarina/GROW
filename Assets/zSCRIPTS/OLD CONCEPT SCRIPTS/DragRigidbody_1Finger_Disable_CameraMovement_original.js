      ...
      if (
        ...
        touch.phase != iPhoneTouchPhase.Canceled    
         ...
         hit.rigidbody.useGravity = true;
               ...
               (GameObject.Find("Main Camera").GetComponent("TOUCH_TO_MOVE_CONSTRAINED_YAXIS_SMOOTHED")as Behaviour ).enabled = false;
               Debug.Log(" Disable ");
...
//   Destroy(dragger);
   (GameObject.Find("Main Camera").GetComponent("TOUCH_TO_MOVE_CONSTRAINED_YAXIS_SMOOTHED")as Behaviour ).enabled = true;
               Debug.Log(" Enabled ");
} 
