...
function FixedUpdate () {
	...
	if(GameObject.FindWithTag("MainCamera"))
	{
		...
		{
			var t : float = accelerator.z;
			
					
			accelerator.y = -accelerator.z;
			accelerator.y = t;
		}
		...
		euler.z = Mathf.Lerp(euler.y, -accelerator.x * maxTurnLean, 0.2);

		// Since we set absolute lean position, do some extra smoothing on it
		euler.z = Mathf.Lerp(euler.y, accelerator.z * maxTilt, 0.2);
